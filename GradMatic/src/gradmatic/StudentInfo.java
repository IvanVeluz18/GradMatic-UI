...
public class StudentInfo {
    ...
    public static void updateStudent(Statement s, int oldStudentID, int studentID, String studentLN, String studentFN, String studentMI, float studentGWA, int sectionID) {
        try {
            s.executeUpdate("update Students set studentID = " + studentID + ", studentLN = '" + studentLN + "', studentFN = '" + studentFN + "', studentMI = '" + studentMI + "', studentGWA = " + studentGWA + ", sectionID = " + sectionID + " where studentID = " + oldStudentID);
        }
        catch (SQLException e) {
            System.err.println(e.getMessage());
        }
    ...
    /* This method creates a new student to add to the database */
    public static void createStudent(Statement s, int studentID, String studentLN, String studentFN, String studentMI, int sectionID) {
        try {
            s.executeUpdate("insert into Students (studentID, studentLN, studentFN, studentMI, studentGWA, sectionID) values (" + studentID + ", '" + studentLN + "', '" + studentFN + "', '" + studentMI + "', 0, " + sectionID + ")");
        }
        catch (SQLException e) {
            System.err.println(e.getMessage());
        }
    ...
    public static void removeStudent(Statement s, int studentID) {
        try {
            ResultSet rs = s.executeQuery("delete from Students where studentID ='" + studentID + "';");
        } catch (SQLException e) {
            System.err.println(e.getMessage());
        }
    }
    ...
    */    
	public static void main(String[] args) {
		...
		try {
            ...
            // createStudent(s, 122, "sorino", "isaac", "s", 1);
